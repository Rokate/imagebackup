...
async def XJW():
    ...
    async with aiohttp.ClientSession() as session:
        ...
        for url in xjw:
            ...
            jscontent = (
            jscontent
            + f'<div class="box"><h1 align="center" style="color:red ; font-size:25px">---------分割线---------</h1><script type="text/javascript" src="https://raw.kgithub.com/Rokate/imagebackup/main/Script/Src/xjw/{filename}"  charset="gb2312"></script></div>'
        )
