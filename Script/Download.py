...
async def main(a,b,c):
    ...
    [f"https://49{qish}9a.com/img/amhg{qishu}.jpg","a-amhg.jpg"],
    [f"https://49{qish}9a.com/img/zbxyb{qishu}.jpg","a-zbxyb.jpg"],
    [f"https://49{qish}9a.com/img/nm4x8m{qishu}.jpg","a-nm4x8m.jpg"],
    [f"https://123186a.com/gsbtu/baoma{qishu}.jpg","a-baoma.jpg"],
    [f"https://123186a.com/gsbtu/hdjr{qishu}.jpg","a-hdjr.jpg"],
    [f"https://49{qish}9a.com/img/jl3x{qishu}.jpg","a-jl3x.jpg"],
    [f"https://www.353583.com/tutu/ujcc{qishu}.jpg","a-ujcc.jpg"],
    [f"https://www.29761b.com/img/djpt{qishu}.jpg","a-djpt.jpg"],
    [f"https://49{qish}9a.com/img/1xzt{qishu}.jpg","a-lxzt.jpg"],
	[f"https://49{qish}9a.com/img/1xzt{qishu}.jpg","a-lxzt.jpg"],
...
if __name__ == '__main__':
    ...
    try:
        qishu = requests.post('https://his.whboligj.com/api/CurrentInfo', headers=headers, data='{"lotteryId":2032}').json()['data']['issue'][-3:]
        qish = str(int(qishu))
        qs = requests.get('https://49152c.com/unite49/h5/picture/detail/latest?pictureTypeId=10870').json()['data']['period']
