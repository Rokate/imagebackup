...
document.writeln("060期红色记忆【独家16码】开？00准<br>");
...
document.writeln("<td height=40 class=\'stylelxz\' align=\"center\">");
document.writeln("<p align=\"center\"><font size=\"4\">");
document.writeln("059期红色记忆【独家16码】开马24准<br>");
document.writeln("</font><font color=\"#FF0000\" size=\"5\">");
document.writeln("（32.01.19.39.09.03.44.38）<br>");
document.writeln("（11.33.07.05.30.<span style='background-color: #FFFF00\'>24</span>.14.40）</font></td>");
document.writeln("</tr>			");
document.writeln("<!----结束----> ");
...
document.writeln("<td height=40 class=\'stylelxz\' align=\"center\">");
document.writeln("<p align=\"center\"><font size=\"4\">");
document.writeln("058期红色记忆【独家16码】开猪31准<br>");
document.writeln("</font><font color=\"#FF0000\" size=\"5\">");
document.writeln("（40.13.<span style='background-color: #FFFF00\'>31</span>.01.39.49.21.43）<br>");
...
document.writeln("<td height=40 class=\'stylelxz\' align=\"center\">");
document.writeln("<p align=\"center\"><font size=\"4\">");
document.writeln("055期红色记忆【独家16码】开狗44准<br>");
document.writeln("</font><font color=\"#FF0000\" size=\"5\">");
document.writeln("（22.43.10.42.08.24.13.35）<br>");
document.writeln("（26.11.01.21.<span style='background-color: #FFFF00\'>44</span>.28.04.02）</font></td>");
document.writeln("</tr>			");
document.writeln("<!----结束----> ");
