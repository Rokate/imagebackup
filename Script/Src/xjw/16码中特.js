...
document.writeln("301期红色记忆【独家16码】开？00准<br>");
...
document.writeln("<td height=40 class=\'stylelxz\' align=\"center\">");
document.writeln("<p align=\"center\"><font size=\"4\">");
document.writeln("298期红色记忆【独家16码】开鸡44准<br>");
document.writeln("</font><font color=\"#FF0000\" size=\"5\">");
document.writeln("（40.13.31.01.39.49.21.43）<br>");
document.writeln("（38.08.28.48.22.<span style='background-color: #FFFF00\'>44</span>.16.42）</font></td>");
document.writeln("</tr>			");
document.writeln("<!----结束----> ");
...
document.writeln("<td height=40 class=\'stylelxz\' align=\"center\">");
document.writeln("<p align=\"center\"><font size=\"4\">");
document.writeln("295期红色记忆【独家16码】开蛇24准<br>");
document.writeln("</font><font color=\"#FF0000\" size=\"5\">");
document.writeln("（22.43.10.42.08.<span style='background-color: #FFFF00\'>24</span>.13.35）<br>");
...
document.writeln("<td height=40 class=\'stylelxz\' align=\"center\">");
document.writeln("<p align=\"center\"><font size=\"4\">");
document.writeln("293期红色记忆【独家16码】开猪30准<br>");
document.writeln("</font><font color=\"#FF0000\" size=\"5\">");
document.writeln("（07.17.49.31.14.<span style='background-color: #FFFF00\'>30</span>.47.36）<br>");
...
document.writeln("<td height=40 class=\'stylelxz\' align=\"center\">");
document.writeln("<p align=\"center\"><font size=\"4\">");
document.writeln("291期红色记忆【独家16码】开兔14准<br>");
document.writeln("</font><font color=\"#FF0000\" size=\"5\">");
document.writeln("（15.43.20.01.16.28.42.22）<br>");
document.writeln("（39.07.33.32.49.17.46.<span style='background-color: #FFFF00\'>14</span>）</font></td>");
document.writeln("</tr>			");
document.writeln("<!----结束----> ");
...
document.writeln("<td height=40 class=\'stylelxz\' align=\"center\">");
document.writeln("<p align=\"center\"><font size=\"4\">");
document.writeln("289期红色记忆【独家16码】开牛04准<br>");
document.writeln("</font><font color=\"#FF0000\" size=\"5\">");
document.writeln("（39.23.44.15.07.27.47.38）<br>");
document.writeln("（<span style='background-color: #FFFF00\'>04</span>.46.35.09.32.26.16.01）</font></td>");
document.writeln("</tr>			");
document.writeln("<!----结束----> ");
